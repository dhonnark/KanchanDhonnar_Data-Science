...
# Give text_input a key so we can clear it
user_answer = st.text_input("Type your answer and press Enter", key="user_input").strip().lower()
...
if user_answer:
    ...
    # Clear input and trigger AI turn only once
    st.session_state.user_input = ""
