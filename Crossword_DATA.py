...
for i in range(5):
    puzzle_grid.append({
        "id": selected_words[i]["id"],
        "answer": selected_words[i]["answer"],
        "clue": selected_words[i]["clue"],
        "row": layout_positions[i]["row"],
        "col": layout_positions[i]["col"],
        "direction": layout_positions[i]["direction"]
    })
